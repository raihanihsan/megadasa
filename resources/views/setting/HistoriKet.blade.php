        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/inputInformasiMahasiswa') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Komentar</label>
                            <div class="col-md-6">
                                
                                <textarea id="tgl" type="date" class="form-control" name="keterangan" ></textarea>
                            </div>
                        </div>
